<%-- 
    Document   : post
    Created on : Jul 23, 2016, 8:14:11 PM
    Author     : gao
--%>
...
.en-markup-crop-options div div:first-of-type {
    ...
    <header class="intro-header" style="background-image: url('<c:url value="/resources/images/ronghua.jpg" />')">
        <div class="container">
            <div class="row">
           ...
           <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                 ...
                 <h3 class="section-heading">${p.text}</h3>
