...
<html>
    ...
    <body>
      ...
      <form:form modelAttribute="user" class="form-signin">
        ...
        <form:input path="username" type="username" id="inputUsername" class="form-control" placeholder="Username" required="" />
        ...
        <a class ="btn btn-default btn-group-lg btn-link " href="<c:url value="/login"/>">Log in</a>
        </div>
    </div> <!-- /container -->
